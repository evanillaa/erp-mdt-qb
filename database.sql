...
CREATE TABLE `mdt_vehicleinfo` (
	...
	`code5` LONGTEXT NOT NULL COLLATE 'utf8mb4_general_ci',
	`stolen` LONGTEXT NOT NULL COLLATE 'utf8mb4_general_ci',
	`info` LONGTEXT NOT NULL COLLATE 'utf8mb4_general_ci',
